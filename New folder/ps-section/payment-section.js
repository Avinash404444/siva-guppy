...
if(profile){
  ...
  <div class="login-title"><h2>make payment on this qr :</h2></div>
...
new QRCode(document.getElementById("qr-section"), {
    ...
    document.querySelector(".login-section").innerHTML=`<div class="login-title"><h2>enter your details :</h2></div>
            ...
            <label for="note">note : <textarea style="width: 70%; border-radius: 5px; margin-left: auto; height: 100px;"  placeholder="whatever you want tell write here " id="note"></textarea></label> `
